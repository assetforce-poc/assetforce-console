 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Authenticate($username: String!, $password: String!) {\n  authenticate(username: $username, password: $password) {\n    success\n    subject\n    availableRealms {\n      realmId\n      realmName\n      displayName\n      zoneId\n      realmType\n      description\n      isActive\n    }\n    accessToken\n    refreshToken\n    expiresIn\n    tokenType\n    identityContext {\n      zone\n      realm\n      subject {\n        accountId\n        userId\n        username\n        email\n        displayName\n      }\n      groups\n    }\n    error\n  }\n}"): (typeof documents)["mutation Authenticate($username: String!, $password: String!) {\n  authenticate(username: $username, password: $password) {\n    success\n    subject\n    availableRealms {\n      realmId\n      realmName\n      displayName\n      zoneId\n      realmType\n      description\n      isActive\n    }\n    accessToken\n    refreshToken\n    expiresIn\n    tokenType\n    identityContext {\n      zone\n      realm\n      subject {\n        accountId\n        userId\n        username\n        email\n        displayName\n      }\n      groups\n    }\n    error\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation SelectTenant($subject: String!, $realmId: String!) {\n  selectTenant(subject: $subject, realmId: $realmId) {\n    success\n    accessToken\n    refreshToken\n    expiresIn\n    tokenType\n    error\n    identityContext {\n      zone\n      realm\n      subject {\n        accountId\n        userId\n        username\n        email\n        displayName\n      }\n      groups\n    }\n  }\n}"): (typeof documents)["mutation SelectTenant($subject: String!, $realmId: String!) {\n  selectTenant(subject: $subject, realmId: $realmId) {\n    success\n    accessToken\n    refreshToken\n    expiresIn\n    tokenType\n    error\n    identityContext {\n      zone\n      realm\n      subject {\n        accountId\n        userId\n        username\n        email\n        displayName\n      }\n      groups\n    }\n  }\n}"];
