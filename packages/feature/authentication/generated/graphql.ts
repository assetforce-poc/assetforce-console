...
export type CheckEmailAvailabilityInRegistrationQuery = { __typename?: 'Query', registration: { __typename?: 'RegistrationQueries', email: { __typename?: 'EmailStatus', available: boolean, reason?: string | null } } };

export type RegisterInRegistrationMutationVariables = Exact<{
  input: RegisterInput;
}>;


export type RegisterInRegistrationMutation = { __typename?: 'Mutation', registration: { __typename?: 'RegistrationMutations', register: { __typename?: 'RegisterResult', success: boolean, accountId?: string | null, message?: string | null, requiresVerification: boolean, appliedTenant?: string | null } } };

export type VerifyEmailInRegistrationMutationVariables = Exact<{
  token: Scalars['String']['input'];
}>;
