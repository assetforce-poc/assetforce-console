...
import { PENDING_INVITE_TOKEN_KEY, INVITE_PAGE_PATH, LOGIN_PAGE_PATH } from '../constants';
 ...
 * ```
 */
export function useInviteTokenRecovery(
  options: UseInviteTokenRecoveryOptions = {}
): UseInviteTokenRecoveryResult {
