...
const documents = {
    ...
    "mutation ResendActivation($accountId: String!) {\n  account {\n    activation {\n      resend(accountId: $accountId) {\n        success\n        expiresAt\n        error {\n          code\n          message\n        }\n      }\n    }\n  }\n}": types.ResendActivationDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation ResendActivation($accountId: String!) {\n  account {\n    activation {\n      resend(accountId: $accountId) {\n        success\n        expiresAt\n        error {\n          code\n          message\n        }\n      }\n    }\n  }\n}"): (typeof documents)["mutation ResendActivation($accountId: String!) {\n  account {\n    activation {\n      resend(accountId: $accountId) {\n        success\n        expiresAt\n        error {\n          code\n          message\n        }\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
